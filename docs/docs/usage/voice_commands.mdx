...
description: 'How to use voice commands with your Omi device'
---
...
### Firmware
- Long press detection: Button held ≥ 1000ms (1 second)
...
## Using Voice Commands with Custom Integrations
